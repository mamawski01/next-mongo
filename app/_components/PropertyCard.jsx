...
export default function PropertyCard({ property }) {
  function getRateDisplay() {
    ...
    if (rates.monthly) return `${rates.monthly.toLocaleString()}/monthly`;
    else if (rates.weekly) return `${rates.weekly.toLocaleString()}/week`;
